...
class ProjectTest extends TestCase
{
  ...
  public function test_user_can_create_a_project()
  {
    ...
    $response = $this->actingAs($this->project)->post('/projects',[
      'client_id' => 1,
      'name' => 'ABC Project',
  ...
  public function test_user_can_update_a_project()
  {
    ...
    $response = $this->actingAs($this->project)->put('/projects/'.$project->id, [
  ...
  public function test_user_can_see_a_project()
  {
    ...
    $response = $this->actingAs($this->project)->get('/projects/'.$project->id);
    $response->assertStatus(200);
  ...
  public function test_user_can_delete_a_project()
  {
    ...
    $response = $this->actingAs($this->project)->delete('/projects/'.$project->id);
    $this->assertTrue(Project::all()->count() == 0);
  }
